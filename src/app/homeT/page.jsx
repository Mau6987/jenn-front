...
export default function TecnicoHome() {
  const cards = [
    {
      ...
      description: "Monitorea en tiempo real las pruebas de reacción y agilidad.",
      image: "/monitoreoreaccion.png",
      hoverImage: "/monitoreoreaccion.png", // no se indicó hover; usamos la misma
      href: "/monitoreo-reaccion",
      blob: "bg-[#E0F2FE]",
      accent: "text-[#0369A1]",
    },
    {
      title: "Monitoreo Pliometría",
      description: "Supervisa las pruebas pliométricas y datos de fuerza.",
      image: "/monitoreopliometroa2.png", // se indicó esta imagen
      hoverImage: "/monitoreopliometroa2.png", // sin alternativa; usamos la misma
      href: "/monitoreo-pliometria",
      blob: "bg-[#DCFCE7]",
      accent: "text-[#15803D]",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-[#f7f7fb] dark:bg-[#0b0f19] text-slate-800 dark:text-slate-100">
      {/* Título igual al estilo anterior: azul oscuro con fondo celeste suave */}
